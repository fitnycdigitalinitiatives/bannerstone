  ...
  <div class="row justify-content-md-center">
    <div class="col-md-6">
      ...
      <section>
        ...
        <p>All images on the ABP (Archaic Bannerstone Project) under the Bannerstone Tab have been designated in the public domain and are therefore free to download and use for any purpose. Under this tab all images are available alphabetized by collection. Under the Collection Tab you can find notes on these specific collections as well as all images and metadata from that collection. Under the Typology Tab you will be able to search by type. By clicking on each bannerstone image you will open up the full suite of images and metadata for this stone. Please attribute photographs to Anna Blume (unless otherwise indicated) and review the separate credit line details under Collections.  Images from each particular collection will be identified by the name of the collection and the catalog or accession number. For instance (AMNH 1/1821) refers to a specific quartz butterfly bannerstone in the American Museum of Natural History. All web essays and resources under the Resource Tab are also available for download. For publishing questions or general suggestions regarding the ABP, contact <a href="mailto:bannerstone@fitnyc.edu">bannerstone@fitnyc.edu</a>.</p>
        <p></p>
      </section>
    </div>
  </div>
